...
Respond helpfully and collaborate with other agents when appropriate.`;
  ...
  async start(): Promise<void> {
    ...
    // Send greeting
    await this.mcpClient.sendMessage(`Hello! I'm ${this.agentName}, a Claude-based coding agent ready to help.`);
